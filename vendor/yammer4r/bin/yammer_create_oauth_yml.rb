...
puts "Please visit the following URL in your browser to authorize your application, then enter the code in here and press enter when done: #{request_token.authorize_url}"
